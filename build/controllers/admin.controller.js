...
class Adminoller {
    constructor() {
        ...
        this.userCreate = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const adminCheck = yield admin_model_1.default.findById(req['tokenId']);
                if (adminCheck) {
                    const requestBody = Object.assign(Object.assign({}, req.body), { lastLoggedIn: (0, moment_1.default)().unix() });
        ...
        this.checkUser = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                const userCheck = yield user_model_1.default.findById(req.params.userId);
                if (userCheck) {
        ...
        this.createItem = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (adminCheck) {
                    ...
                    const requestBody = Object.assign(Object.assign({}, req.body), { itemid: itemid, lastLoggedIn: (0, moment_1.default)().unix() });
                    const user = yield item_model_1.default.create(requestBody);
                    if (user) {
                        res.status(201).json("Done");
                    }
                }
